...
public class TemplateController {
	...
	@PostMapping("/add")
	public Template addTemplate(@RequestBody Template template) throws Exception {
	...
	@GetMapping("/findByCriteria/{id}/{value}")
	public List<Template> findByCriteria(@PathVariable String value,@PathVariable  Long id) {
		return templateService.findByCriteria(value, id);
	}
